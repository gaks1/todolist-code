...
# 📖 [To do list web page] <a name="about-project"></a>

**[To do list web page]** is a simple webpage that adds and removes tasks to be done.
...
- **[task interaction ]**- allow tasks to be checked complete and those checked to be deleted.
...
git clone git@github.com:gaks1/To-do-list.git
...
Feel free to check the [issues page](https://github.com/gaks1/To-do-list/issues ).
